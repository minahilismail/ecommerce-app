...
export class ProductService {
  ...
  addProduct(productData: any, imageFile?: File): Observable<ProductModel> {
    ...
    return this.http.post<ProductModel>(`${this.apiUrl}/Product`, formData);
  }
  ...
  editProduct(productData: any, imageFile?: File): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/Product/${productData.id}`, formData);
  }
  ...
  uploadProductImage(productId: number, imageFile: File): Observable<any> {
    ...
    return this.http.post(`${this.apiUrl}/Product/uploadImage`, formData);
  }
